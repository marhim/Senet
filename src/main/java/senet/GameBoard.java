...
public class GameBoard {
  ...
  private final int cols = 51;
  private final String[][] gb = new String[rows][cols];
  ...
  /**
   * Generates the game board with multiple for-loops. TODO: Replace for-loops because they are
   * unreadable, confusing and not maintainable.
   */
